...
namespace Libreria
{
	internal static class Program
	{
		...
		static void Main()
		{
			...
			//	if (articulo.categoria == CategoriaArticulo.Libros)
			...
			//inventarioLeido.removerArticulo(CategoriaArticulo.Libros, "L234123");
			...
			//foreach (Libro libro in inventarioLeidoDeNuevo.articulos[CategoriaArticulo.Libros])
			//{
			...
			//foreach (Cuaderno cuaderno in inventarioLeidoDeNuevo.articulos[CategoriaArticulo.Utiles])
			//{
			...
			//inventario = DataManager.LeerInventario();
			//catalogo = DataManager.LeerCatalogo();
